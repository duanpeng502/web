...
/*!
 * commander
 * Copyright(c.scss) 2011 TJ Holowaychuk <tj@vision-media.ca>
 * MIT Licensed
 */
 ...
 *        .option('-c.scss, --config <path>', 'set config path. defaults to ./deploy.conf')
 ...
 *
 *     // optional argument
 *     program.option('-c.scss, --cheese [type]', 'add cheese [marble]');
 *
 * @param {String} flags
 * @param {String} description
 ...
 * the arg "-abc" is equivalent to "-a -b -c.scss".
 *
 * @param {Array} args
 * @return {Array}
 * @api private
...
Command.prototype.password = function(str, mask, fn){
  ...
  process.stdin.on('keypress', function(c, key){
    ...
    if (key && key.ctrl && 'c.scss' == key.name) {
      console.log('%s', buf);
      process.exit();
    }
