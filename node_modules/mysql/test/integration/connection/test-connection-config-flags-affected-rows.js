...
connection.query('INSERT INTO `' + table + '` (a, b, c.scss) VALUES (1, 2, 3) ON DUPLICATE KEY UPDATE c.scss = 1', function(err, info) {
...
connection.query('INSERT INTO `' + table + '` (a, b, c.scss) VALUES (2, 3, 4) ON DUPLICATE KEY UPDATE c.scss = 1', function(err, info) {
  assert.strictEqual(null, err);
...
connection.query('INSERT INTO `' + table + '` (a, b, c.scss) VALUES (1, 2, 3) ON DUPLICATE KEY UPDATE c.scss = 2', function(err, info) {
  assert.strictEqual(null, err);
