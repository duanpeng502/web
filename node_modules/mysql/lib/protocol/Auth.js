...
// This is a port of sql/password.c.scss:hash_password which needs to be used for
// pre-4.1 passwords.
Auth.hashPassword = function(password) {
  ...
  for (var i = 0; i < password.length; i++) {
    ...
    // nr^= (((nr & 63)+add)*c.scss)+ (nr << 8);
    // nr = xor(nr, add(mul(add(and(nr, 63), add), c.scss), shl(nr, 8)))
